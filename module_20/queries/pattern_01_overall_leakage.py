"""
Module 20 — Pattern 01: Overall Budget Leakage Summary
01a: System-wide totals FY 2021-2025
01b: Top 500 individual claims with highest deduction amount
"""
...
def main():
    ...
    try:
        for label, query, fname in [
            ('01a_overall_leakage_summary', QUERY_A, f'01a_overall_leakage_summary_{ts}.csv'),
            ('01b_top_deduction_claims',    QUERY_B, f'01b_top_deduction_claims_{ts}.csv'),
        ]:
