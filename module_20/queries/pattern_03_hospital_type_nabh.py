"""
Module 20 — Pattern 03: Hospital Type & NABH Leakage
03a: Deduction breakdown by hospital type and NABH status
03b: ALL individual claims from hospitals with high deduction (Type M, N, H, 0)
"""
...
def main():
    ...
    try:
        for label, query, fname in [
            ('03a_hospital_type_nabh_summary', QUERY_A, f'03a_hospital_type_nabh_summary_{ts}.csv'),
            ('03b_type_all_deduction_claims',  QUERY_B, f'03b_type_all_deduction_claims_{ts}.csv'),
        ]:
