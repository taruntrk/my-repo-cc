...
def main():
    ...
    try:
        with connection.cursor() as cursor:
            ...
            print("\nExtracting Pattern 6 (Individual Card-Sharing)...")
            query_card = """
                SELECT 
                ...
                WHERE ci1.CI_ADMISSION_DATE >= '2021-01-01'
                  AND cs1.CS_UTI_APP_AMT >= 20000 
                  AND cs2.CS_UTI_APP_AMT >= 20000
            ...
            print("\nExtracting Pattern 7 (Family Simultaneous Admissions)...")
            query_family = """
                SELECT 
