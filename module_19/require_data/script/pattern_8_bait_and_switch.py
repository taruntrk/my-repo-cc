...
csv_file = os.path.join(DATA_DIR, f"new_19_08_pattern_8_bait_and_switch_{timestamp}.csv")
...
def extract_pattern_8_bait_and_switch():
    """Extracts RAW claims to find Prior Approval Inflation (Bait & Switch)."""
    print("Extracting Pattern 8: The Bait & Switch - Prior Approval Inflation (RAW FULL DATA)...")
    ...
    SELECT 
        ...
        c.CI_EXTENDED_STAY as extended_stay_days,
        c.CI_APPROX_COST as initial_estimate_amount,
        cs.CS_GR_CLAIM_AMT as final_billed_amount,
        cs.CS_UTI_APP_AMT as final_approved_amount,
...
if __name__ == "__main__":
    extract_pattern_8_bait_and_switch()
